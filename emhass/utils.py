...
def get_yaml_parse(config_path: pathlib.Path, use_secrets: Optional[bool] = True,
    ...
    retrieve_hass_conf = {key: d[key] for d in input_conf['retrieve_hass_conf'] for key in d}
    if use_secrets:
    ...
    optim_conf['list_hp_periods'] = {key: d[key] for d in optim_conf['list_hp_periods'] for key in d}
