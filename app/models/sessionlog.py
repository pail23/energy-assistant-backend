...
class SessionLogEntry(Base):
    ...
    async def read_by_id(
        cls, session: AsyncSession, id: int) -> SessionLogEntry | None:
    ...
    @classmethod
    async def create(cls, session: AsyncSession, text: str, device_id: uuid.UUID, start: datetime, start_solar_consumed_energy: float, start_consumed_energy: float, end: datetime, end_solar_consumed_energy:float,  end_consumed_energy: float) -> SessionLogEntry:
    ...
    async def update(self, session: AsyncSession, text: str, device_id: uuid.UUID, start: datetime, start_solar_consumed_energy: float, start_consumed_energy: float, end: datetime, end_solar_consumed_energy:float,  end_consumed_energy: float) -> None:
