...
async def import_data(
    ...
    states_repository._read_states.to_csv("data/state_history.csv")
        ...
        try:
            ...
            if home_measurement is None:
                home_measurement = await HomeMeasurement.create(
                    ...
                    consumed_energy=energy_state.consumed_energy,
                    solar_consumed_energy=energy_state.consumed_solar_energy,
